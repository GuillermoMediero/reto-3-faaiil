...
@section('rol')
    ...
    @foreach ($ascensores as $ascensor)
        ...
        <div class="row border border-dark mt-3 justify-content-center">
        ...
        @endif
         ...
         <div class="d-none d-md-block col-md-2"></div>
            <div class="col-md-4 col-5 text-center align-self-center ">
                <div class="btn-group d-block d-md-inline-block" role="group" aria-label="Basic example">
                        ...
                        <div class="d-none d-md-block col-md-1 "></div>
                            <div class=" col-11 col-md-12 ">
                                <div class="row d-flex">
                                    <div class=" col-3 col-md-2 d-flex align-self-center"><h5>Fecha y hora</h5> </div> 
                                    <div class=" col-3 col-md-2 d-flex align-self-center"><h5>Tipo</h5> </div> 
                                    <div class=" col-3 col-md-2 d-flex align-self-center"><h5>Modelo</h5> </div> 
                                    <div class=" col-3 col-md-2 d-flex align-self-center"><h5>Segmento</h5> </div> 
                                    <div class="d-none d-md-block col-md-2 d-flex align-self-center" ><h5>Detalles operario</h5> </div> 
                                    <div class="d-none d-md-block col-md-2 align-self-center"><h5>Detalles tecnico</h5> </div> 
                                </div>
                                <div class="row d-flex">
                                    <div class=" col-3 col-md-2 d-flex align-self-center"><p class="me-5">{{ $incidencia->created_at }}</p> </div> 
                                    <div class=" col-3 col-md-2 d-flex align-self-center"><p class="me-5">{{ $incidencia->tipo }}</p> </div> 
                                    <div class=" col-3 col-md-2 d-flex align-self-center"><p class="me-5">{{ $ascensor->modelo_id }}</p> </div> 
                                    <div class=" col-3 col-md-2 d-flex align-self-center"><p class="me-5">{{ $ascensor->segmento }}</p> </div> 
                                    <div class="d-none d-md-block col-md-2 align-self-center"><p class="me-5">{{ $incidencia->detalles_op }}</p> </div> 
                                    <div class="d-none d-md-block col-md-2 align-self-center"><p class="me-5">{{ $incidencia->detalles_tec  }}</p> </div> 
                                </div>
                                </div>
                        </div>
                        </div>
